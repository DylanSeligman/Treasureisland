...
if choice1 == "left":
  ...
  if choice2 == "wait":
    ...
    if choice3 == "red":
      ...
      print ("The chest was filled with gold. You're rich!")
    elif choice3 == "blue":
      print("The chest was empty. You stink as an adventurer.")
    else:
      print("You took to long to decide and the natives took you hostage and then killed you.")
  else:
    print("The water was filled with piranhas and they swarmed you. You did not survive.")
else:
  print("you felt yourself trapped in quicksand and sank to your death.")
